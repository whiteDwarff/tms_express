 ...
 * @doc https://api.ncloud-docs.com/docs/ai-naver-papagonmt-translation
 */
export async function translateKoToEn(text) {
  if (!text) throw new NotFoundError('번역할 텍스트가 없습니다.');
  ...
  try {
    ...
    throw new Error('papago 번역에 실패하였습니다.', error.message);
  }
}